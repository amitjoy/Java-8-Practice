...
public final class ToValuesExamples {

	public double averageNumberOfTracks(final List<Album> albums) {
		final ToIntFunction<Album> func = album -> album.getTrackList().size();
		return albums.stream().collect(Collectors.averagingInt(func));
	}
